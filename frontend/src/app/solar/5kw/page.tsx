...
export const metadata = buildMetadata({ title: '5 kW Solar System | Bhasko', description: 'Our most popular size for larger homes with 2-3 ACs.', canonical: 'solar/5kw/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="5 kW Solar System" subtitle="Our most popular size for larger homes with 2-3 ACs." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
