...
export const metadata = buildMetadata({ title: 'Hybrid Solar | Bhasko', description: 'Grid-tied solar with battery backup for power cuts and night-time use.', canonical: 'solar-solutions/hybrid/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Hybrid Solar" subtitle="Grid-tied solar with battery backup for power cuts and night-time use." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
