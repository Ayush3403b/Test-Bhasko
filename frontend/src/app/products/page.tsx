...
export const metadata = buildMetadata({ title: 'Solar Products & Equipment | Bhasko', description: 'Tier-1 panels, inverters, batteries, EV chargers and accessories that Bhasko recommends based on your requirements.', canonical: 'products/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar Products & Equipment" subtitle="Tier-1 panels, inverters, batteries, EV chargers and accessories that Bhasko recommends based on your requirements." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
