...
export const metadata = buildMetadata({ title: 'Digital Solar Survey | Bhasko', description: '10 questions. A personalized roof score and recommendation. Book a physical engineering survey at the end.', canonical: 'digital-survey/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Digital Solar Survey" subtitle="10 questions. A personalized roof score and recommendation. Book a physical engineering survey at the end." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
