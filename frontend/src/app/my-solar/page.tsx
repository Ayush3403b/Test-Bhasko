...
export const metadata = buildMetadata({ title: 'My Solar — Customer Portal | Bhasko', description: 'Track your generation, savings, project progress, service requests and AMC.', canonical: 'my-solar/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="My Solar — Customer Portal" subtitle="Track your generation, savings, project progress, service requests and AMC." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
