...
// House, Tree, Sun & Energy Flow in the gap (Preserved exactly as designed)
...
// Clean Calculator Container with ambient glow framing
export default function HeroVisual({ children }: { children?: React.ReactNode }) {
  return (
    <div className="relative w-full">
      {/* Subtle ambient light behind calculator */}
      <div 
        className="absolute -inset-3 rounded-[36px] opacity-40 blur-2xl pointer-events-none -z-10"
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(168,214,109,0.3) 0%, rgba(244,185,66,0.15) 50%, transparent 80%)',
        }}
      />
      {children}
    </div>
