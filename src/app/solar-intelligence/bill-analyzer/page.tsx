...
export const metadata = buildMetadata({ title: 'Electricity Bill Analyzer | Bhasko', description: 'Upload your latest electricity bill PDF or photo. We extract your consumer number, units, tariff and charges — then feed them into our calculation engine.', canonical: 'solar-intelligence/bill-analyzer/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Electricity Bill Analyzer" subtitle="Upload your latest electricity bill PDF or photo. We extract your consumer number, units, tariff and charges — then feed them into our calculation engine." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
