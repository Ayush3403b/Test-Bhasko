...
export const metadata = buildMetadata({ title: 'Instant Solar Report | Bhasko', description: 'Get a premium branded solar PDF report — with recommendation, generation, savings, subsidy, payback, equipment and CO₂ impact — delivered to your inbox.', canonical: 'solar-intelligence/report/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Instant Solar Report" subtitle="Get a premium branded solar PDF report — with recommendation, generation, savings, subsidy, payback, equipment and CO₂ impact — delivered to your inbox." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
