...
export const metadata = buildMetadata({ title: '3 kW Solar System | Bhasko', description: 'Ideal for 3 BHK homes with 1-2 ACs and bills around ₹3,000-4,500.', canonical: 'solar/3kw/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="3 kW Solar System" subtitle="Ideal for 3 BHK homes with 1-2 ACs and bills around ₹3,000-4,500." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
