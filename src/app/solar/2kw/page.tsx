...
export const metadata = buildMetadata({ title: '2 kW Solar System | Bhasko', description: 'Ideal for 2-3 BHK homes with bills around ₹2,000-2,800 per month.', canonical: 'solar/2kw/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="2 kW Solar System" subtitle="Ideal for 2-3 BHK homes with bills around ₹2,000-2,800 per month." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
