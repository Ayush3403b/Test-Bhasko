...
export const metadata = buildMetadata({ title: '5 kW+ Solar Systems | Bhasko', description: 'For villas, large bungalows and homes with EVs and heavy loads.', canonical: 'solar/5kw-plus/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="5 kW+ Solar Systems" subtitle="For villas, large bungalows and homes with EVs and heavy loads." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
