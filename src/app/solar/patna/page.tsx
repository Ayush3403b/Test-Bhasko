...
export const metadata = buildMetadata({ title: 'Solar Panels in Patna | Bhasko', description: 'Rooftop solar installation in Patna — pricing, subsidy, DISCOM process and local case studies.', canonical: 'solar/patna/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar Panels in Patna" subtitle="Rooftop solar installation in Patna — pricing, subsidy, DISCOM process and local case studies." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
