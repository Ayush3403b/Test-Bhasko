...
export const metadata = buildMetadata({ title: 'Solar Panels in Bihar | Bhasko', description: 'Rooftop solar across Bihar with PM Surya Ghar subsidy support.', canonical: 'solar/bihar/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar Panels in Bihar" subtitle="Rooftop solar across Bihar with PM Surya Ghar subsidy support." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
