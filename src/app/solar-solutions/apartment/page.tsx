...
export const metadata = buildMetadata({ title: 'Apartment & Society Solar | Bhasko', description: 'Rooftop solar for apartment societies: common areas, lifts, pumps, lighting and EV charging.', canonical: 'solar-solutions/apartment/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Apartment & Society Solar" subtitle="Rooftop solar for apartment societies: common areas, lifts, pumps, lighting and EV charging." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
