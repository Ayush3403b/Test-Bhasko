...
export const metadata = buildMetadata({ title: 'Off-Grid Solar | Bhasko', description: 'Standalone solar systems for areas with no grid or unreliable supply.', canonical: 'solar-solutions/off-grid/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Off-Grid Solar" subtitle="Standalone solar systems for areas with no grid or unreliable supply." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
