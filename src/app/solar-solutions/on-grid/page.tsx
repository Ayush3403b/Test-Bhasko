...
export const metadata = buildMetadata({ title: 'On-Grid Solar | Bhasko', description: 'Grid-tied rooftop solar — the most popular system for homes and businesses in India.', canonical: 'solar-solutions/on-grid/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="On-Grid Solar" subtitle="Grid-tied rooftop solar — the most popular system for homes and businesses in India." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
