...
export const metadata = buildMetadata({ title: 'Solar + Battery | Bhasko', description: 'Add battery storage to your rooftop solar for backup and self-consumption.', canonical: 'solar-solutions/battery/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar + Battery" subtitle="Add battery storage to your rooftop solar for backup and self-consumption." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
