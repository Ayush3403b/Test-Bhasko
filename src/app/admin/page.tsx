...
export const metadata = buildMetadata({ title: 'Admin Dashboard | Bhasko', description: 'Bhasko admin dashboard — leads, projects, content and analytics.', canonical: 'admin/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Admin Dashboard" subtitle="Bhasko admin dashboard — leads, projects, content and analytics." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
