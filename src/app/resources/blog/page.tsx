...
export const metadata = buildMetadata({ title: 'Solar Blog | Bhasko', description: 'Engineering explainers, policy updates, customer stories and honest solar advice.', canonical: 'resources/blog/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar Blog" subtitle="Engineering explainers, policy updates, customer stories and honest solar advice." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
