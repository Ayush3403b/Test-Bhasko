...
export const metadata = buildMetadata({ title: 'Solar News | Bhasko', description: 'Industry news, policy changes and DISCOM updates.', canonical: 'resources/news/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Solar News" subtitle="Industry news, policy changes and DISCOM updates." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
