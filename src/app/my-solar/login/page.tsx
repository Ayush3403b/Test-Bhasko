...
export const metadata = buildMetadata({ title: 'Login — My Solar | Bhasko', description: 'Sign in to your Bhasko customer portal.', canonical: 'my-solar/login/page' });
export default function Page() {
  return (
    <>
      <PageHero eyebrow="BHASKO" title="Login — My Solar" subtitle="Sign in to your Bhasko customer portal." primaryCta={{ label: 'Calculate Savings', href: '/solar-intelligence/calculator' }} secondaryCta={{ label: 'Talk to Expert', href: '/contact' }} />
